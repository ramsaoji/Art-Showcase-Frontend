      ...
      <Disclosure as="nav" className="relative">
        {({ open }) => (
          <>
            ...
            {/* Mobile menu panel (Disclosure.Panel) */}
            <Disclosure.Panel className="lg:hidden bg-white absolute left-0 right-0 top-full z-50 shadow-2xl border-t border-gray-100">
