    ...
    <div className="relative min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="max-w-3xl mx-auto text-center mb-10">
          <h1 className="font-artistic text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 tracking-wide">
            Art Gallery
          </h1>
        ...
        <div className="mb-12">
          ...
          <div className="hidden lg:flex flex-wrap items-center justify-between gap-4 mb-6">
            ...
            <div className="flex flex-wrap items-center gap-4">
              {/* Featured Filter */}
              <Menu as="div" className="relative">
                <Menu.Button className="inline-flex items-center px-4 py-2.5 rounded-full text-sm font-sans bg-white shadow-sm border border-gray-200 text-gray-700 hover:bg-gray-50 transition-colors">
              ...
              <Menu as="div" className="relative">
                <Menu.Button className="inline-flex items-center px-4 py-2.5 rounded-full text-sm font-sans bg-white shadow-sm border border-gray-200 text-gray-700 hover:bg-gray-50 transition-colors">
                  <FunnelIcon className="h-5 w-5 mr-2" />
                  Material:{" "}
                  {filters.material === "all" ? "All" : filters.material}
                </Menu.Button>
                <Transition
                  as={Fragment}
                  enter="transition ease-out duration-100"
                ...
                >
                  <Dialog.Panel className="relative flex flex-col w-full h-[90vh] mt-auto bg-white rounded-t-3xl px-4 pb-4">
                    <div className="flex items-center justify-between py-4 border-b border-gray-200">
                      <Dialog.Title className="text-lg font-artistic font-semibold text-gray-900">
                        Filters & Sort
                      </Dialog.Title>
                      <button
                        type="button"
                    ...
                    <div className="flex-1 py-6 overflow-y-auto">
                      {/* Sort Options */}
                      <div className="mb-8">
                        <h3 className="text-sm font-sans font-medium text-gray-500 mb-4">
                          Sort by
                        </h3>
